...
# Verificar que no queden valores nulos en estas columnas
...
### Ademas de convertir los datos categoricos en general para aplicar estos datos en modelos de machine learnign, ademas de verificar el balanceo de datos y aplicacion de tecnicas para corregir variables con outlayers
...
## OneHotEncoder
### Internet_Access, Extracurricular_Activities, School_Type, GenderLearning_Disabilities
```{python}
