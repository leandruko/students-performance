...
- Para el tratamiento de datos atipicos lo que vamos a realizar es la imputacion de ellos mediante el metodo intercuartilico, pero tambien vamos a dgenerar un dataset sin realizar ningun tratamiento de los datos outlayers presentes en el dataset para eralizar pruebas posterirmente en dla aplicacion de modelos de machine learning para ver cuanta diferencia hay entre ambos casos
