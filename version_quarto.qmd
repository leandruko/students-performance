...
# Gráfico de barras para comparar la media de 'Exam_Score' por 'Parental_Involvement'
plt.figure(figsize=(8, 5))
sns.barplot(x='Parental_Involvement', y='Exam_Score', data=df, palette='Set2')
plt.title('Promedio de Puntuación de Examen por Involucramiento Parental')
plt.xlabel('Involucramiento Parental')
plt.ylabel('Promedio de Exam Score')
plt.xticks(rotation=45)
plt.show()
